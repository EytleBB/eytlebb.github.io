...
- **New patch log entry**: create `logs/YYYY-MM-DD.txt` and push — Action auto-updates `logs/index.json`. The calendar hard-starts at March 2026 (`y=2026, m=2` in `renderPatchlog`); update if adding older entries.
